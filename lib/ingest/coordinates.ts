...
export const PARK_COORDS: ParkCoord[] = [
  ...
  { match: /Algonquin\s*-\s*Achray/i, lat: 45.864, lng: -77.711, region: "Central",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1682687220742-aba13b6e50ba?w=1200" },
  { match: /Algonquin\s*-\s*Basin Lake/i, lat: 45.731, lng: -78.404, region: "Central",
    heroImageUrl: "https://images.unsplash.com/photo-1509660933414-108c8832f723?w=1200" },
  { match: /Algonquin\s*-\s*Brent/i, lat: 46.0, lng: -78.498, region: "Central",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1516253573831-97c6e2a0e5c4?w=1200" },
  { match: /Algonquin\s*-\s*Canisbay/i, lat: 45.572, lng: -78.476, region: "Central",
    heroImageUrl: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=1200" },
  ...
  { match: /Algonquin\s*-\s*Kingscote/i, lat: 45.272, lng: -78.243, region: "Central",
    heroImageUrl: "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=1200" },
  { match: /Algonquin\s*-\s*Kiosk/i, lat: 46.014, lng: -78.882, region: "Central",
    heroImageUrl: "https://images.unsplash.com/photo-1504204267155-aabd8860b4a3?w=1200" },
  { match: /Algonquin\s*-\s*Lake of Two Rivers/i, lat: 45.575, lng: -78.487, region: "Central",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=1200" },
  { match: /Algonquin\s*-\s*Mew Lake/i, lat: 45.581, lng: -78.502, region: "Central",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1518709766631-a6a7f45921c3?w=1200" },
  { match: /Algonquin\s*-\s*Pog Lake/i, lat: 45.567, lng: -78.470, region: "Central",
    heroImageUrl: "https://images.unsplash.com/photo-1542224566-6e85f2e6772f?w=1200" },
  ...
  { match: /Algonquin\s*-\s*Tea Lake/i, lat: 45.55, lng: -78.601, region: "Central",
    heroImageUrl: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1200" },
  { match: /Algonquin\s*-\s*Tim River/i, lat: 45.793, lng: -78.917, region: "Central",
    heroImageUrl: "https://images.unsplash.com/photo-1484291150161-469ed31c0a51?w=1200" },
  { match: /Algonquin\s*-\s*Whitefish/i, lat: 45.521, lng: -78.392, region: "Central",
    heroImageUrl: "https://images.unsplash.com/photo-1433086966358-54859d0ed716?w=1200" },
  { match: /Algonquin Backcountry/i, lat: 45.836, lng: -78.379, region: "Central",
    description: "Interior canoe routes across the park.",
    heroImageUrl: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=1200" },
  ...
  { match: "Bon Echo", lat: 44.892, lng: -77.211, region: "Southeastern",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1465056836041-7f43ac27dcb5?w=1200" },
  ...
  { match: "Killarney", lat: 46.013, lng: -81.401, region: "Northeastern",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1496080174650-637e3f22fa03?w=1200" },
  ...
  { match: /^Pinery$|The Pinery/i, lat: 43.247, lng: -81.831, region: "Southwestern",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1455496231601-e6195da1f841?w=1200" },
  ...
  { match: "Sandbanks", lat: 43.913, lng: -77.241, region: "Southeastern",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1502780402662-acc01917cf91?w=1200" },
  ...
  { match: "Pukaskwa", lat: 48.587, lng: -86.286, region: "Northern",
    ...
    heroImageUrl: "https://images.unsplash.com/photo-1499678329028-101435549a4e?w=1200" },
