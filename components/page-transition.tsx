...
/**
 * Light SPA transition: each new route keeps the page visible while React
 * settles the next tree.
 *
 ...
 * tree, eliminating the flicker. `initial={false}` also keeps SSR output
 * visible if hydration or motion startup is delayed.
 */
